...
SEARCH_FIRST_SOURCES: set[str] = {*COMPETITOR_SOURCES, NON_MAINSTREAM_MEDIA_SOURCE, MSX_SOURCE, AI_SOURCE}
PROCESSING_SOURCES: set[str] = {"x", BINANCE_SQUARE_SOURCE, JIN10_SOURCE, *SEARCH_FIRST_SOURCES}
